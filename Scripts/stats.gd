...
# O sinal abaixo serve para criar barras de vida
...
# Sempre que for se referir a um stat em código, usar o current
var current_max_health: int = 100
var current_defense: int = 10
var current_attack: int = 10
var health: int = 1: set = _on_health_set
...
func _on_health_set(new_value: int) -> void:
	...
	# A linha abaixo serve para criar barras de vida
